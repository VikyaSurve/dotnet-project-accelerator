...
{
  "gitBranch" : "main",
  "gitRepository" : "https://github.com/VikyaSurve/dotnet-project-accelerator",
  "liveUpdateIDESupport" : false,
  "projectName" : "dotnet-project-accelerator",
  "targetProject" : "dotnet-project-accelerator"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [my-project->dotnet-project-accel...(truncated)]
